...
export interface ActionRequest<T = any> {
  actionType: string;
  data: T; // Use a more specific type if possible
}
...
export interface MintRequest {
  ...
  recipientAddress: string;
  tokenMintAddress: string;
  metadata?: Record<string, any>; // Optional metadata for the NFT or token being minted
}
...
export interface CreateRequest<T = any> {
  ...
  data: T; // Data necessary for creation
}
